...
**PO Auto-Creation**
The system auto-generates a PO in **Draft** status once Finance coding is completed on a PR line item with document type = PO. A unique **PO number is assigned at Draft** — the moment the PO is created.
